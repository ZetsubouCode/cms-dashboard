                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex align-items-center list-user-action">
                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"  href="{{ route('user.edit', $data->id) }}">
                                ...
                                <button class="btn btn-sm btn-icon btn-danger" onclick="openDeleteModal('{{ $data->name }}','{{route('user.delete', $data->id)}}')" title="Delete">
                                   <span class="btn-inner">
