...
<div class="card col-md-10 mx-auto">
    <div class="card-header d-flex justify-content-between">
        <div class="header-title">
            <h4 class="card-title">Input Product Category</h4>
        </div>
    </div>
    
    <div class="card-body">
        <p>Please fill out the details below to add a new payment method</p> 
        <form action="{{ route('productcategory.create') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-select mb-3 shadow-none" name="status" required>
